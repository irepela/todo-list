...
module.exports = "<div *ngIf=\"message\" [ngClass]=\"{ 'alert': message, 'alert-success': message.type === 'success',\r\n'alert-danger': message.type === 'error' }\">{{message.text}}</div>\r\n"
...
var appConfig = {
    apiUrl: 'https://irepela-todo-list.herokuapp.com'
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__shared_authentication_service__ = __webpack_require__("../../../../../src/app/shared/authentication.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__shared_authenticated_guard__ = __webpack_require__("../../../../../src/app/shared/authenticated.guard.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__app_routing__ = __webpack_require__("../../../../../src/app/app.routing.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__alert_alert_component__ = __webpack_require__("../../../../../src/app/alert/alert.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__shared_jwt_interceptor__ = __webpack_require__("../../../../../src/app/shared/jwt.interceptor.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__alert_alert_service__ = __webpack_require__("../../../../../src/app/alert/alert.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__user_user_service__ = __webpack_require__("../../../../../src/app/user/user.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__todo_todo_data_service__ = __webpack_require__("../../../../../src/app/todo/todo-data.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_9__alert_alert_component__["a" /* AlertComponent */],
            ...
            providers: [
                __WEBPACK_IMPORTED_MODULE_7__shared_authenticated_guard__["a" /* AuthenticatedGuard */],
                __WEBPACK_IMPORTED_MODULE_13__alert_alert_service__["a" /* AlertService */],
                __WEBPACK_IMPORTED_MODULE_6__shared_authentication_service__["a" /* AuthenticationService */],
                __WEBPACK_IMPORTED_MODULE_14__user_user_service__["a" /* UserService */],
                __WEBPACK_IMPORTED_MODULE_15__todo_todo_data_service__["a" /* TodoDataService */],
                __WEBPACK_IMPORTED_MODULE_12__shared_jwt_interceptor__["a" /* JwtInterceptorProvider */]
            ],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__todo_todo_component__ = __webpack_require__("../../../../../src/app/todo/todo.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__shared_authenticated_guard__ = __webpack_require__("../../../../../src/app/shared/authenticated.guard.ts");
...
var APP_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_0__todo_todo_component__["a" /* TodoComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_1__shared_authenticated_guard__["a" /* AuthenticatedGuard */]] },
    { path: 'login', component: __WEBPACK_IMPORTED_MODULE_3__login_login_component__["a" /* LoginComponent */] },
    { path: 'register', component: __WEBPACK_IMPORTED_MODULE_4__register_register_component__["a" /* RegisterComponent */] },
    { path: '**', redirectTo: '' }
];
var Routing = __WEBPACK_IMPORTED_MODULE_2__angular_router__["d" /* RouterModule */].forRoot(APP_ROUTES);
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authenticationService.login(this.model.username, this.model.password)
            ...
            if (data.error) {
                _this.alertService.error(data.error.message);
                _this.loading = false;
            }
            else {
...
/***/ "../../../../../src/app/shared/authenticated.guard.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var AuthenticationService = /** @class */ (function () {
    ...
    AuthenticationService.prototype.login = function (username, password) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_3__app_config__["a" /* appConfig */].apiUrl + '/authenticate', { username: username, password: password })
            .pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["a" /* map */])(function (user) {
...
/***/ "../../../../../src/app/todo/todo-data.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var TodoDataService = /** @class */ (function () {
    ...
    TodoDataService.prototype.initializeTodos = function (todos) {
        this.todos = todos.slice();
    };
    TodoDataService.prototype.getInitialTodos = function (currUser) {
        currUser = currUser;
        return this.http.get(__WEBPACK_IMPORTED_MODULE_2__app_config__["a" /* appConfig */].apiUrl + '/getTodos/' + currUser.username);
    };
    ...
    TodoDataService.prototype.toggleTodoComplete = function (todo) {
        ...
        var currUser = JSON.parse(sessionStorage.getItem('currentUser'));
        this.http.post(__WEBPACK_IMPORTED_MODULE_2__app_config__["a" /* appConfig */].apiUrl + '/toggleTodo', { username: currUser.username, todo: todo })
            .subscribe(function (response) { });
        return updatedTodo;
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__todo_data_service__ = __webpack_require__("../../../../../src/app/todo/todo-data.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__todo__ = __webpack_require__("../../../../../src/app/todo/todo.ts");
...
var TodoComponent = /** @class */ (function () {
    function TodoComponent(todoDataService, authService, router) {
    ...
    TodoComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.todosSubscription = this.todoDataService.getInitialTodos(this.currentUser).subscribe(function (todos) {
            _this.todoDataService.initializeTodos(todos);
        });
    };
    ...
    TodoComponent.prototype.onLogout = function () {
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.create = function (user) {
        return this.http.post(__WEBPACK_IMPORTED_MODULE_2__app_config__["a" /* appConfig */].apiUrl + '/register', user);
    };
